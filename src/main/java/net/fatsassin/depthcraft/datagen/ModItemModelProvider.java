...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        trimmedArmorItem(ModItems.SCUBA_HELMET);
        trimmedArmorItem(ModItems.SCUBA_CHESTPLATE);
        trimmedArmorItem(ModItems.SCUBA_LEGGINS);
        trimmedArmorItem(ModItems.SCUBA_BOOTS);
    }

    // Shoutout to El_Redstoniano for making this
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = Depthcraft.MODID; // Change this to your mod id
